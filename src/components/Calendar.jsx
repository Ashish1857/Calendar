...
import { format, addMonths, subMonths, startOfWeek, endOfWeek, startOfMonth, endOfMonth, eachDayOfInterval, isSameMonth } from 'date-fns';
  ...
  const renderCalendarDays = () => {
    ...
    return weeks.map((week, index) => (
      <React.Fragment key={index}>
        ...
        {selectedGame && week.some(dayCell => dayCell.props.gameRelease?.date === selectedGame.date) && (
